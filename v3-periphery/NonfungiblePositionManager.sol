    ...
    SelfPermit
{
    ...
    ) ERC721Permit('Purple V3 Positions NFT-V1', 'PURP-V3-POS', '1') PeripheryImmutableState(_deployer, _factory, _WETH9) {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IPurpleV3Pool pool = IPurpleV3Pool(PoolAddress.computeAddress(deployer, poolKey));
