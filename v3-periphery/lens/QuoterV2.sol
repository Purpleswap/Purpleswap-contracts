...
contract QuoterV2 is IQuoterV2, IPancakeV3SwapCallback, PeripheryImmutableState {
    ...
    using PoolTicksCounter for IPurpleV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IPurpleV3Pool) {
        return IPurpleV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function pancakeV3SwapCallback(
        ...
        IPurpleV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IPurpleV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
